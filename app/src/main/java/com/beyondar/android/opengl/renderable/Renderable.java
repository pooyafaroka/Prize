...
public interface Renderable {
	...
	/**
	 * This method is called when the {@link Renderable Renderable} is not rendered, for
	 * example because is too far
	 */
	public void onNotRendered(double dst);

	/**
	 * Get the texture object for the {@link Renderable Renderable}
	 * 
	 * @return
	 */
	...
	/**
	 * Get the plane that represents the {@link Renderable Renderable}. Used for collision
	 * detection.
	 * 
	 * @return
	 */
	...
	/**
	 * Set the position where the {@link Renderable Renderable} needs to be rendered.
	 * 
	 * @param x
	 * @param y
	 * @param z
	...
	/**
	 * Get the position where the {@link Renderable Renderable} will be rendered.
	 * 
	 * @return
	 */
	...
	/**
	 * Set the angle of the {@link Renderable Renderable}.
	 * 
	 * @param x
	 * @param y
	 * @param z
	...
	/**
	 * Get the angle of the {@link Renderable Renderable}.
	 * 
	 * @return
	 */
